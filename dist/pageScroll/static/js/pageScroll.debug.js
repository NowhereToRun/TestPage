...
// CONCATENATED MODULE: ./src/js/lib/zepto.js
var _typeof=typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?function(obj){return typeof obj;}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;};/* Zepto v1.2.0 - zepto event ajax form ie - zeptojs.com/license */// (function(global, factory) {
...
else if(type=="array"||!traditional&&type=="object")serialize(params,value,traditional,key);else params.add(key,value);});}$.param=function(obj,traditional){var params=[];params.add=function(key,value){if($.isFunction(value))value=value();if(value==null)value="";this.push(escape(key)+'='+escape(value));};serialize(params,obj,traditional);return params.join('&').replace(/%20/g,'+');};})(Zepto);(function($){$.fn.serializeArray=function(){var name,type,result=[],add=function add(value){if(value.forEach)return value.forEach(add);result.push({name:name,value:value});};if(this[0])$.each(this[0].elements,function(_,field){type=field.type,name=field.name;if(name&&field.nodeName.toLowerCase()!='fieldset'&&!field.disabled&&type!='submit'&&type!='reset'&&type!='button'&&type!='file'&&(type!='radio'&&type!='checkbox'||field.checked))add($(field).val());});return result;};$.fn.serialize=function(){var result=[];this.serializeArray().forEach(function(elm){result.push(encodeURIComponent(elm.name)+'='+encodeURIComponent(elm.value));});return result.join('&');};$.fn.submit=function(callback){if(0 in arguments)this.bind('submit',callback);else if(this.length){var event=$.Event('submit');this.eq(0).trigger(event);if(!event.isDefaultPrevented())this.get(0).submit();}return this;};})(Zepto);(function(){// getComputedStyle shouldn't freak out when called
// without a valid element as argument
try{getComputedStyle(undefined);}catch(e){var nativeGetComputedStyle=getComputedStyle;window.getComputedStyle=function(element,pseudoElement){try{return nativeGetComputedStyle(element,pseudoElement);}catch(e){return null;}};}})();//   return Zepto
// }))
/* harmony default export */ var zepto = (Zepto);
// CONCATENATED MODULE: ./src/js/tools.js
var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}var statusTools=function(){function statusTools(){_classCallCheck(this,statusTools);this.wrapper=null;this.allItems={};this.init();}_createClass(statusTools,[{key:'init',value:function init(){var wrapper=$('#j_status_tools');if(!wrapper.length){this.wrapper=$('<div id="j_status_tools" style="position:fixed; top:0; right:0; max-height:200px;min-height:50px; width:200px; background:rgba(45, 67, 72, 0.8);padding: 0 5px;z-index: 9999;"></div>');$(document.body).append(this.wrapper);}else{this.wrapper=wrapper;}}},{key:'addItem',value:function addItem(id,msg){var selector='j_status_p___'+id;if(!$('#'+selector).length){var item=$('<p id="j_status_p___'+id+'" style="color:#0cd8d4;font-size: 13px;">'+id+': <span class="j_'+id+'"></span></p>');this.wrapper.append(item);this.allItems[id]=item;if(msg!=null){this.allItems[id].find('.j_'+id).text(msg);}}else{this.updateItem(id,msg);}}},{key:'updateItem',value:function updateItem(id,msg){if(this.allItems[id]&&msg!=null){this.allItems[id].find('.j_'+id).text(msg);}}}]);return statusTools;}();/* harmony default export */ var tools = (statusTools);
// CONCATENATED MODULE: ./src/view/pageScroll/index.js
var statusPanel=new tools();var lastTime=new Date();function showScrollTop(){statusPanel.addItem('touchmove',document.body.scrollTop||document.documentElement.scrollTop);}window.addEventListener('scroll',function(){statusPanel.addItem('scrollTop',document.body.scrollTop||document.documentElement.scrollTop);});var pageMain=document.querySelector('.page_main');pageMain.addEventListener('touchmove',showScrollTop);function showTime(){var time=new Date();var hours=time.getHours();var minus=time.getMinutes();var secs=time.getSeconds();if(hours>=0&&hours<=9){hours="0"+hours;}if(minus>=0&&minus<=9){minus="0"+minus;}if(secs>=0&&secs<=9){secs="0"+secs;}statusPanel.addItem('time',hours+':'+minus+':'+secs);setTimeout(function(){showTime();$.ajax({url:'http://10.222.22.54:8888'});},1000);}showTime();
